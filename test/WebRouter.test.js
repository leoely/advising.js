...
describe('[Class] WebRouter;', () => {
  ...
  //test('WebRouter nedd to support both query parameters and path variables.', () => {
    ...
    //});
    //webRouter.add('/movie/action//{page}/{index}', ['Thunderbolts', 'Sinners', 'Havoc'], true);
    //expect(JSON.stringify(webRouter.match('/movie/action//1/1?k1=v1&k2=v2', false, true))).toMatch('{\"content\":[\"Thunderbolts\",\"Sinners\",\"Havoc\"],\"queryParams\":{\"k2\":\"v2\",\"k1\":\"v1\"},\"pathVariables\":{\"page\":\"1\",\"index\":\"1\"}}');
  //});
  ...
  //test('WebRouter should be able to adpat to URL parameters..', () => {
    ...
    //});
    //webRouter.add('/movie/action//{page}/{index}', ['Thunderbolts', 'Sinners', 'Havoc'], true);
    //expect(JSON.stringify(webRouter.match('/movie/action//1/1', false, true))).toMatch('{\"content\":[\"Thunderbolts\",\"Sinners\",\"Havoc\"],\"queryParams\":{},\"pathVariables\":{\"page\":\"1\",\"index\":\"1\"}}');
    //expect(JSON.stringify(webRouter.match('/movie/action?k1=v1&k2=v2', false, true))).toMatch('{\"content\":[\"Thunderbolts\",\"Sinners\",\"Havoc\"],\"queryParams\":{\"k2\":\"v2\",\"k1\":\"v1\"},\"pathVariables\":{}}');
    //expect(JSON.stringify(webRouter.match('/movie/action', false, true))).toMatch('{\"content\":[\"Thunderbolts\",\"Sinners\",\"Havoc\"],\"queryParams\":{},\"pathVariables\":{}}');
  //});
